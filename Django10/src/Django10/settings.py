...
# 구글계정에서 할당받은 ID, PASSWORD저장
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY='404115638827-evqflieeit3h44kr8t8ptfmkf445tc0p.apps.googleusercontent.com'  # ID값 저장
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET='9ByUlNDcfSg5PSP_5h_eChk6' #보안비밀 값 저장
...
INSTALLED_APPS = [
    ...
    #python에 social-auth-app-django 모듈이 설치되어야함.
    'social_django', # 소셜로그인에 관련된 처리르 하는 어플리케이션
    'blog'
]
...
#http://127.0.0.1:8000/files/로 시작하는 경로는 미디어 파일을 불러오는 것으로 판단.
MEDIA_URL ='/files/'
